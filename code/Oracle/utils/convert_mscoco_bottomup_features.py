...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="/home/mmazuecos/oracle_spatial_code/lxmert/data/mscoco_imgfeat/train2014_obj36.tsv"
    )
    parser.add_argument(
        "--load_mscoco_bottomup_val_tsv_filename",
        type=str,
        default="/home/mmazuecos/oracle_spatial_code/lxmert/data/mscoco_imgfeat/val2014_obj36.tsv"
    )
    parser.add_argument(
        "--save_mscoco_bottomup_info_json_filename",
        type=str,
        default="/home/mmazuecos/oracle_spatial_code/lxmert/data/mscoco_imgfeat/mscoco_bottomup_info.json"
    )
    parser.add_argument(
        "--save_mscoco_bottomup_features_npy_filename",
        type=str,
        default="/home/mmazuecos/oracle_spatial_code/lxmert/data/mscoco_imgfeat/save_mscoco_bottomup_features.npy"
    )
    parser.add_argument(
        "--save_mscoco_bottomup_boxes_npy_filename",
        type=str,
        default="/home/mmazuecos/oracle_spatial_code/lxmert/data/mscoco_imgfeat/save_mscoco_bottomup_boxes.npy"
    )
